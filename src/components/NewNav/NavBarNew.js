  ...
  return (
    <nav className={`${styles.navbar} ${isSticky ? styles.sticky : ''}`}>
        ...
        <div className={`${styles.mobileMenu} ${isClosing ? styles.closing : ''}`}>
          <div className={styles.mobileMenuContent}>
            ...
            <div className={styles.center}>
              <img className={styles.image} src={logo} alt="בתאל צרפתי לוגו"/>
            </div>
          </div>
        </div>
      )}
      ...
      <div className={styles.socialIcons}>
        <a href="https://www.instagram.com/batel_skincareboutique/" target="_blank" rel="noopener noreferrer"><FaInstagram /></a>
